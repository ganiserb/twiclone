...
urlpatterns = patterns('',
    url(r'^post_new_tag_form/$',
        views.post_new_tag_form,
        name='post_new_tag_form'),

    url(r'^post_profile_form/$',
        views.post_profile_form,
        name='post_profile_form'),

    url(r'^post_edit_tags_form/$',
